...
class MyPasscodeScreen extends StatefulWidget {
  final String title;
  ...
  @override
  State<StatefulWidget> createState() => _MyPasscodeScreenState();
}

class _MyPasscodeScreenState extends State<MyPasscodeScreen>
  ...
  Color circleFillColor = Colors.white;
  ...
  @override
  didUpdateWidget(MyPasscodeScreen old) {
...
class KeyboardUIConfig {
  ...
  KeyboardUIConfig({
    ...
    this.digitTextStyle = const TextStyle(fontSize: 30, color: Colors.white, fontWeight: FontWeight.w300),
